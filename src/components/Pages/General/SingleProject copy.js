...
{ Fn.get("isAuthenticated") &&
            ...
            /> */}
                                ...
                                {Fn.get("isAuthenticated") && typeof this.context.account !== "undefined" &&
                                  typeof this.context.account.user.id !==
                                    "undefined" &&
                                  this.state.projectOwner.id ===
                                    this.context.account.user.id && (
                                    <div className="flex flex-row mt5 pb5   bb b--black-05">
                                      <div className="flex flex-auto flex-column pb0 ">
                                                ...
                                                (
                                                  ...
                                                  >
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        {/* <div className={" flex f7 fw6 black-70 "}>
                 Position
                </div> */}
                                                        <div
                                                          className={
