...
class MyProjectsProduction extends React.Component {
  ...
  fetchProjects() { 
    ...
    if(Fn.get('onboardingProfile').accountType === "production") {
      Fn.fetchOwnProjects({ self: this })
  ...
  filterProjects(filter) {
    ...
    let projects = typeof localStorage.getItem('ownProjects') !== null && JSON.parse(localStorage.getItem('ownProjects')) || [];
                  ...
                  <div className="flex flex-row">
                    ...
                    <button
                      ...
                      <span className="f5 fw6 white pv0 flex items-center justify-center">
                        ...
                        {this.state.buttonLoading ? <Icon icon={"loading"} iconSize={15} className={' absolute right-0 f4 black-60 mr2'} /> : <Icon icon={"small-plus"} iconSize={15} className={(' f4 black-60 mr2 absolute right-0')} />} Create a Project</span>
                    </button>
...
export default MyProjectsProduction;
MyProjectsProduction.contextType = AccountContext.Consumer