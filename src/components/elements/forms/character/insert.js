    ...
    return (
      <div>
        ...
        >
          ...
          <form onSubmit={this.insertCharacter} className="pa5 flex flex-column h-100 overflow-auto">
            ...
            <div className="flex flex-column items-center justify-center w-100 pb4 pt5">
              <button type={'submit'} className="bn flex flex-row items-center ph5 pv2-5 br5 bg-cyan bs-b-cyan relative">
