...
class NetworkActivity extends React.Component {
  ...
  async fetchConversation() {
    console.log("fetchConversation", this.props.project.conversation);

    await api
      .fetch("conversations", this.props.project.conversation)
  ...
  getDerivedStateFromProps = (nextProps, prevState) => {
    console.log("Files getDerivedStateFromProps", nextProps, prevState);
  };

  getSnapshotBeforeUpdate = (prevProps, prevState) => {
    console.log("Files getSnapshotBeforeUpdate", prevProps, prevState);
  };

  componentDidUpdate = () => {
    console.log("Files did update");
  };

  componentWillUnmount = () => {
    console.log("Files will unmount");
  };
...
NetworkActvity.contextType = AccountContext;
